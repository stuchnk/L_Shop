(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=e=>{let t=document.createElement(e.tag);return e.className&&(t.className=e.className),e.textContent&&(t.textContent=e.textContent),e.innerHTML&&(t.innerHTML=e.innerHTML),e.attributes&&Object.entries(e.attributes).forEach(([e,n])=>{t.setAttribute(e,n)}),e.children&&e.children.forEach(e=>t.appendChild(e)),e.onClick&&t.addEventListener(`click`,e.onClick),e.onInput&&t.addEventListener(`input`,e.onInput),e.onChange&&t.addEventListener(`change`,e.onChange),t},t=[],n=(e,n)=>{t.push({path:e,handler:n})},r=e=>{window.history.pushState({},``,e),a()},i=(e,t)=>{let n=e.split(`/`),r=t.split(`/`);if(n.length!==r.length)return null;let i={};for(let e=0;e<n.length;e++)if(n[e].startsWith(`:`))i[n[e].slice(1)]=r[e];else if(n[e]!==r[e])return null;return i},a=()=>{let e=window.location.pathname;for(let n of t){let t=i(n.path,e);if(t!==null){n.handler(t);return}}let n=t.find(e=>e.path===`/`);n&&n.handler()},o=()=>{window.addEventListener(`popstate`,a),a()},s=`lshop_token`,c=`lshop_user`,l=`lshop_delivery`,u=e=>{localStorage.setItem(s,e.token),localStorage.setItem(c,JSON.stringify(e.user)),window.dispatchEvent(new CustomEvent(`auth:changed`))},d=()=>{localStorage.removeItem(s),localStorage.removeItem(c),window.dispatchEvent(new CustomEvent(`auth:changed`))},f=()=>localStorage.getItem(s)||``,p=()=>{let e=localStorage.getItem(c);if(!e)return null;try{return JSON.parse(e)}catch{return null}},m=()=>!!(f()&&p()),h=e=>{localStorage.setItem(l,JSON.stringify(e))},g=()=>{let e=localStorage.getItem(l);if(!e)return{city:``,address:``,phone:``,comment:``};try{return JSON.parse(e)}catch{return{city:``,address:``,phone:``,comment:``}}},_=`lshop_theme`,v=e=>e===`light`||e===`dark`,y=()=>window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`,b=()=>{let e=document.documentElement.dataset.theme;if(v(e||null))return e;let t=localStorage.getItem(_);return v(t)?t:y()},x=(e,t=!0)=>{document.documentElement.dataset.theme=e,document.documentElement.style.colorScheme=e,localStorage.setItem(_,e),t&&window.dispatchEvent(new CustomEvent(`theme:changed`))},ee=()=>{x(b(),!1)},te=()=>{x(b()===`dark`?`light`:`dark`)},ne=e=>e.split(` `).map(e=>e[0]).join(``).slice(0,2).toUpperCase(),S=(t,n)=>e({tag:`a`,className:`header__link`,textContent:t,attributes:{href:n},onClick:e=>{e.preventDefault(),r(n)}}),C=()=>{let t=p(),n=m(),i=b(),a=[S(`Каталог`,`/`),S(`Корзина`,`/cart`),e({tag:`button`,className:`header__theme-toggle`,attributes:{type:`button`,"aria-label":i===`dark`?`Переключить на светлую тему`:`Переключить на тёмную тему`,title:i===`dark`?`Переключить на светлую тему`:`Переключить на тёмную тему`},onClick:()=>{te()},children:[e({tag:`span`,className:`header__theme-icon`,textContent:i===`dark`?`☀`:`☾`})]})];return n&&t?(a.push(e({tag:`button`,className:`header__profile`,attributes:{type:`button`},onClick:()=>r(`/profile`),children:[e({tag:`span`,className:`header__avatar`,textContent:ne(t.name)}),e({tag:`span`,className:`header__profile-copy`,children:[e({tag:`span`,className:`header__profile-label`,textContent:`Профиль`}),e({tag:`span`,className:`header__profile-name`,textContent:t.name})]})]})),a.push(e({tag:`button`,className:`header__logout`,textContent:`Выйти`,attributes:{type:`button`},onClick:()=>{d(),r(`/`)}}))):a.push(S(`Войти`,`/login`)),e({tag:`header`,className:`header`,children:[e({tag:`div`,className:`header__inner`,children:[e({tag:`button`,className:`header__brand`,attributes:{type:`button`},onClick:()=>r(`/`),children:[e({tag:`span`,className:`header__logo-mark`,textContent:`LS`}),e({tag:`span`,className:`header__logo-copy`,children:[e({tag:`span`,className:`header__logo-title`,textContent:`L_Shop`}),e({tag:`span`,className:`header__logo-subtitle`,textContent:`Стильные покупки каждый день`})]})]}),e({tag:`nav`,className:`header__nav`,children:a})]})]})},w=`http://localhost:3000/api`,T=()=>{throw d(),alert(`Сессия истекла. Войдите заново.`),r(`/login`),Error(`Unauthorized`)},re=async()=>{let e=await fetch(`${w}/basket`,{credentials:`include`});if(e.status===401&&T(),!e.ok)throw Error(`Ошибка загрузки корзины`);return e.json()},E=async e=>{let t=await fetch(`${w}/basket`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify(e)});if(t.status===401&&T(),!t.ok)throw Error(`Ошибка добавления в корзину`);return t.json()},D=async(e,t)=>{let n=await fetch(`${w}/basket/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify({quantity:t})});if(n.status===401&&T(),!n.ok)throw Error(`Ошибка обновления количества`);return n.json()},O=async e=>{let t=await fetch(`${w}/basket/${e}`,{method:`DELETE`,credentials:`include`});if(t.status===401&&T(),!t.ok)throw Error(`Ошибка удаления из корзины`);return t.json()},k=`http://localhost:3000/api`,A=async e=>{let t=new URLSearchParams;e.search&&t.append(`search`,e.search),e.sortBy&&t.append(`sortBy`,e.sortBy),e.category&&t.append(`category`,e.category),e.available&&t.append(`available`,e.available);let n=await fetch(`${k}/products?${t.toString()}`,{credentials:`include`});if(!n.ok)throw Error(`Ошибка загрузки товаров`);return n.json()},ie=async e=>{let t=await fetch(`${k}/products/${e}`,{credentials:`include`});if(!t.ok)throw Error(`Товар не найден`);return t.json()},ae=async()=>{let e=await fetch(`${k}/products/categories`,{credentials:`include`});if(!e.ok)throw Error(`Ошибка загрузки категорий`);return e.json()},j=e=>{let t=Math.round(e);return`${`★`.repeat(t)}${`☆`.repeat(5-t)} ${e.toFixed(1)}`},M=(t,n)=>{let r=1,i=e({tag:`span`,className:`card__qty-val`,textContent:`1`});return e({tag:`article`,className:`card ${t.available?``:`card--disabled`}`,children:[e({tag:`div`,className:`card__img-wrap`,onClick:()=>n.onOpenProduct(t),children:[e({tag:`img`,className:`card__img`,attributes:{src:t.image,alt:t.name,loading:`lazy`}}),e({tag:`span`,className:`card__badge ${t.available?`card__badge--in`:`card__badge--out`}`,textContent:t.available?`В наличии`:`Под заказ`})]}),e({tag:`div`,className:`card__body`,children:[e({tag:`div`,className:`card__topline`,children:[e({tag:`span`,className:`card__category`,textContent:t.category}),e({tag:`span`,className:`card__rating`,textContent:j(t.rating)})]}),e({tag:`h3`,className:`card__name`,textContent:t.name,attributes:{"data-title":t.name},onClick:()=>n.onOpenProduct(t)}),e({tag:`p`,className:`card__desc`,textContent:t.description}),e({tag:`div`,className:`card__meta`,children:[e({tag:`div`,className:`card__price-block`,children:[e({tag:`span`,className:`card__price-label`,textContent:`Цена`}),e({tag:`span`,className:`card__price`,textContent:`${t.price.toFixed(2)} BYN`,attributes:{"data-price":String(t.price)}})]}),e({tag:`span`,className:`card__stock`,textContent:t.available?`${t.quantity} шт. на складе`:`Поставка ожидается`})]}),e({tag:`div`,className:`card__footer`,children:[e({tag:`div`,className:`card__qty`,children:[e({tag:`button`,className:`card__qty-btn`,textContent:`−`,onClick:e=>{e.stopPropagation(),r>1&&(--r,i.textContent=String(r))}}),i,e({tag:`button`,className:`card__qty-btn`,textContent:`+`,onClick:e=>{e.stopPropagation(),r<t.quantity&&(r+=1,i.textContent=String(r))}})]}),e({tag:`button`,className:`card__cart-btn ${t.available?``:`card__cart-btn--disabled`}`,textContent:t.available?`В корзину`:`Недоступно`,attributes:t.available?{type:`button`}:{disabled:`true`},onClick:e=>{e.stopPropagation(),t.available&&n.onAddToCart(t,r)}})]})]})]})},N=(t,n,r)=>e({tag:`div`,className:`filters__group`,children:[e({tag:`label`,className:`filters__label`,textContent:t}),e({tag:`p`,className:`filters__hint`,textContent:n}),...r]}),P=(t,n,r)=>{let i={...n},a=null,o=()=>{a&&clearTimeout(a),a=setTimeout(()=>{r.onFilterChange({...i})},250)},s=e({tag:`aside`,className:`filters`,children:[e({tag:`div`,className:`filters__intro`,children:[e({tag:`span`,className:`filters__eyebrow`,textContent:`Navigation`}),e({tag:`h3`,className:`filters__title`,textContent:`Настройте витрину под ваш сценарий`}),e({tag:`p`,className:`filters__text`,textContent:`Отберите только те позиции, которые подходят по категории, доступности и формату покупки.`})]}),N(`Поиск`,`По названию или описанию`,[e({tag:`input`,className:`filters__input`,attributes:{type:`text`,placeholder:`Например, ноутбук или монитор`,value:i.search},onInput:e=>{i.search=e.target.value,o()}})]),N(`Сортировка`,`Управляйте порядком карточек`,[e({tag:`select`,className:`filters__select`,innerHTML:`
          ...
          `,onChange:e=>{i.sortBy=e.target.value,r.onFilterChange({...i})}})]),N(`Категория`,`Переключайтесь между коллекциями`,[e({tag:`select`,className:`filters__select`,innerHTML:`
            <option value="">Все категории</option>
            ${t.map(e=>`<option value="${e}" ${i.category===e?`selected`:``}>${e}</option>`).join(``)}
          `,onChange:e=>{i.category=e.target.value,r.onFilterChange({...i})}})]),N(`Доступность`,`Смотрите только актуальные товары`,[e({tag:`select`,className:`filters__select`,innerHTML:`
          ...
          `,onChange:e=>{i.available=e.target.value,r.onFilterChange({...i})}})]),e({tag:`button`,className:`filters__reset`,textContent:`Сбросить настройки`,onClick:()=>{i.search=``,i.sortBy=``,i.category=``,i.available=``,r.onFilterChange({...i});let e=s.parentElement;e&&(e.innerHTML=``,e.appendChild(P(t,i,r)))}})]});return s},F={search:``,sortBy:``,category:``,available:``},oe=async(e,t)=>{if(!m()){alert(`Для добавления товара в корзину войдите в аккаунт.`),r(`/login`);return}try{await E({productId:e.id,name:e.name,price:e.price,quantity:t,image:e.image}),alert(`Товар добавлен в корзину.`)}catch(e){if(e instanceof Error&&e.message===`Unauthorized`)return;d(),alert(`Сессия завершилась. Войдите снова.`),r(`/login`)}},se=e=>{r(`/product/${e.id}`)},I=t=>t.length===0?e({tag:`div`,className:`products__empty`,innerHTML:`
      ...
      `}):e({tag:`div`,className:`products__grid`,children:t.map(e=>M(e,{onAddToCart:oe,onOpenProduct:se}))}),ce=async()=>{let t=document.getElementById(`app`);if(!t)return;let n=t.querySelector(`.main`);n&&n.remove();let r=e({tag:`main`,className:`main home-page`,children:[e({tag:`section`,className:`home__hero`,children:[e({tag:`div`,className:`home__hero-copy`,children:[e({tag:`span`,className:`home__eyebrow`,textContent:`Curated Retail`}),e({tag:`h1`,className:`home__hero-title`,textContent:`Технологии, вещи и повседневные предметы в единой premium-витрине`}),e({tag:`div`,className:`home__hero-tags`,children:[e({tag:`span`,className:`home__hero-tag`,textContent:`Нишевость`}),e({tag:`span`,className:`home__hero-tag`,textContent:`Излишки`}),e({tag:`span`,className:`home__hero-tag`,textContent:`Стиль`})]})]}),e({tag:`div`,className:`home__hero-panel`,children:[e({tag:`div`,className:`home__hero-card home__hero-card--accent`,innerHTML:`
                ...
                `}),e({tag:`div`,className:`home__hero-card home__hero-card--image`,innerHTML:`
  ...
  `;let t=e.querySelector(`#login-form`),n=U();return t.append(n),e.querySelector(`#to-register`).addEventListener(`click`,()=>{r(`/register`)}),t.addEventListener(`submit`,async e=>{e.preventDefault();let i=new FormData(t),a=String(i.get(`email`)||``).trim(),o=String(i.get(`password`)||``).trim();n.textContent=``;let s=le(a,o);if(s){n.textContent=s;return}try{let e=await H({email:a,password:o});u({token:e.token,user:e.user}),r(`/`)}catch(e){n.textContent=e instanceof Error?e.message:`Ошибка авторизации`}}),e},de=()=>{let e=document.createElement(`main`);e.className=`main auth-page`,e.innerHTML=`
    <section class="auth-card">
      <div class="auth-card__badge">L_Shop</div>
  ...
  `;let t=e.querySelector(`#register-form`),n=U();return t.append(n),e.querySelector(`#to-login`).addEventListener(`click`,()=>{r(`/login`)}),t.addEventListener(`submit`,async e=>{e.preventDefault();let i=new FormData(t),a=String(i.get(`name`)||``).trim(),o=String(i.get(`email`)||``).trim(),s=String(i.get(`password`)||``).trim();n.textContent=``;let c=W(a,o,s);if(c){n.textContent=c;return}try{let e=await V({name:a,email:o,password:s});u({token:e.token,user:e.user}),r(`/`)}catch(e){n.textContent=e instanceof Error?e.message:`Ошибка регистрации`}}),e},G=`http://localhost:3000/api`,fe=async e=>{let t=await fetch(`${G}/delivery`,{method:`POST`,headers:{"Content-Type":`application/json`},credentials:`include`,body:JSON.stringify(e)});if(!t.ok){let e=await t.json();throw Error(e.message||`Ошибка оформления доставки`)}return t.json()},pe=async()=>{let e=await fetch(`${G}/delivery`,{credentials:`include`});if(!e.ok)throw Error(`Ошибка загрузки доставок`);return e.json()},me=e=>{let t=document.getElementById(`orders-container`);if(t){if(!e.length){t.innerHTML=`
    ...
    `;return}t.innerHTML=[...e].sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()).map(e=>{let t=new Date(e.createdAt).toLocaleString(),n=e.totalPrice.toFixed(2),r=e.items.map(e=>`
      ...
      `}).join(``)}},he=()=>{let e=document.createElement(`main`);if(e.className=`main profile-page`,!m())return e.innerHTML=`
  ...
  `;let i=e.querySelector(`#delivery-form`),a=e.querySelector(`#delivery-message`),o=e.querySelector(`#orders-container`);return i.addEventListener(`submit`,e=>{e.preventDefault();let t=new FormData(i);h({city:String(t.get(`city`)||``).trim(),address:String(t.get(`address`)||``).trim(),phone:String(t.get(`phone`)||``).trim(),comment:String(t.get(`comment`)||``).trim()}),a.textContent=`Данные для доставки сохранены`}),pe().then(e=>{me(e)}).catch(()=>{o.innerHTML=`<p>Ошибка загрузки заказов</p>`}),e},ge=(t,n)=>e({tag:`div`,className:`cart-item`,children:[e({tag:`img`,className:`cart-item__img`,attributes:{src:t.image,alt:t.name}}),e({tag:`div`,className:`cart-item__info`,children:[e({tag:`h3`,className:`cart-item__name`,textContent:t.name,attributes:{"data-title":t.name}}),e({tag:`span`,className:`cart-item__price`,textContent:`${t.price.toFixed(2)} BYN`,attributes:{"data-price":String(t.price)}})]}),e({tag:`div`,className:`cart-item__controls`,children:[e({tag:`button`,className:`cart-item__btn`,textContent:`−`,onClick:async()=>{t.quantity>1?await D(t.productId,t.quantity-1):await O(t.productId),await n()}}),e({tag:`span`,className:`cart-item__qty`,textContent:String(t.quantity)}),e({tag:`button`,className:`cart-item__btn`,textContent:`+`,onClick:async()=>{await D(t.productId,t.quantity+1),await n()}}),e({tag:`button`,className:`cart-item__remove`,textContent:`Удалить`,onClick:async()=>{await O(t.productId),await n()}})]}),e({tag:`span`,className:`cart-item__total`,textContent:`${(t.price*t.quantity).toFixed(2)} BYN`})]}),K=(t,n,i,a,o)=>{t.appendChild(e({tag:`div`,className:`cart-empty`,innerHTML:`
        <span class="cart-empty__eyebrow">Basket</span>
        <h2>${n}</h2>
        <p>${i}</p>
        <button class="cart-empty__btn" id="cart-state-btn">${a}</button>
      `})),document.getElementById(`cart-state-btn`)?.addEventListener(`click`,()=>{r(o)})},_e=async()=>{let t=document.getElementById(`app`);if(!t)return;let n=t.querySelector(`.main`);n&&n.remove();let i=e({tag:`main`,className:`main`,children:[e({tag:`div`,className:`cart-page`,attributes:{id:`cart-container`}})]});t.appendChild(i);let a=document.getElementById(`cart-container`);if(!a)return;if(!m()){K(a,`Корзина доступна после входа`,`Авторизуйтесь, чтобы хранить товары, оформлять доставку и видеть актуальную историю покупок.`,`Перейти ко входу`,`/login`);return}let o=async()=>{a.innerHTML=``;try{let t=await re();if(t.length===0){K(a,`В корзине пока нет товаров`,`Добавьте несколько позиций из каталога, чтобы перейти к оформлению заказа.`,`Вернуться в каталог`,`/`);return}let n=t.reduce((e,t)=>e+t.quantity,0),i=t.reduce((e,t)=>e+t.price*t.quantity,0);a.appendChild(e({tag:`div`,className:`cart-page__hero`,children:[e({tag:`div`,className:`cart-page__hero-copy`,children:[e({tag:`span`,className:`cart-page__eyebrow`,textContent:`Checkout Preview`}),e({tag:`h2`,className:`cart-page__title`,textContent:`Корзина готова к оформлению`}),e({tag:`p`,className:`cart-page__text`,textContent:`Проверьте состав заказа, скорректируйте количество и переходите к доставке.`})]}),e({tag:`div`,className:`cart-page__hero-total`,children:[e({tag:`span`,className:`cart-page__hero-label`,textContent:`Итог`}),e({tag:`strong`,className:`cart-page__hero-price`,textContent:`${i.toFixed(2)} BYN`})]})]}));let s=e({tag:`div`,className:`cart-page__layout`}),c=e({tag:`div`,className:`cart-list`});t.forEach(e=>{c.appendChild(ge(e,o))});let l=e({tag:`aside`,className:`cart-summary`,children:[e({tag:`span`,className:`cart-summary__eyebrow`,textContent:`Summary`}),e({tag:`h3`,className:`cart-summary__title`,textContent:`Сводка заказа`}),e({tag:`div`,className:`cart-summary__row`,children:[e({tag:`span`,textContent:`Позиции`}),e({tag:`span`,textContent:String(n)})]}),e({tag:`div`,className:`cart-summary__row`,children:[e({tag:`span`,textContent:`Товаров`}),e({tag:`span`,textContent:String(t.length)})]}),e({tag:`div`,className:`cart-summary__row cart-summary__row--total`,children:[e({tag:`span`,textContent:`Итого`}),e({tag:`span`,className:`cart-summary__total`,textContent:`${i.toFixed(2)} BYN`})]}),e({tag:`p`,className:`cart-summary__note`,textContent:`На следующем шаге вы подтвердите адрес, контактные данные и способ оплаты.`}),e({tag:`button`,className:`cart-summary__order-btn`,textContent:`Перейти к доставке`,onClick:()=>r(`/delivery`)})]});s.appendChild(c),s.appendChild(l),a.appendChild(s)}catch{a.appendChild(e({tag:`div`,className:`cart-empty`,textContent:`Не удалось загрузить корзину. Попробуйте обновить страницу.`}))}};await o()},ve=/^[^\s@]+@[^\s@]+\.[^\s@]+$/,ye=/^[A-Za-zА-Яа-яЁёІіЇїЄє\s-]{2,}$/,be=/^[A-Za-zА-Яа-яЁёІіЇїЄє\s.'-]{2,}$/,q=e=>e.replace(/\D/g,``),xe=e=>e.replace(/[^\d+]/g,``),J=e=>q(e).slice(0,16).replace(/(\d{4})(?=\d)/g,`$1 `).trim(),Y=e=>{let t=q(e).slice(0,4);return t.length<=2?t:`${t.slice(0,2)}/${t.slice(2)}`},Se=e=>{if(!/^\d{2}\/\d{2}$/.test(e))return!1;let[t,n]=e.split(`/`),r=Number(t),i=Number(n)+2e3;if(!r||r<1||r>12)return!1;let a=new Date,o=a.getFullYear(),s=a.getMonth()+1;return!(i<o||i===o&&r<s)},X=e=>{let t=new FormData(e);return{city:String(t.get(`city`)||``).trim(),address:String(t.get(`address`)||``).trim(),phone:xe(String(t.get(`phone`)||``).trim()),email:String(t.get(`email`)||``).trim(),comment:String(t.get(`comment`)||``).trim(),cardNumber:J(String(t.get(`cardNumber`)||``).trim()),cardHolder:String(t.get(`cardHolder`)||``).trim(),expiry:Y(String(t.get(`expiry`)||``).trim()),cvv:q(String(t.get(`cvv`)||``).trim()).slice(0,3)}},Z=e=>{let t={};return e.city?ye.test(e.city)||(t.city=`Укажите корректное название города`):t.city=`Введите город`,e.address?e.address.length<5&&(t.address=`Адрес должен быть не короче 5 символов`):t.address=`Введите адрес доставки`,e.phone?/^\+?\d{10,15}$/.test(e.phone)||(t.phone=`Телефон должен содержать от 10 до 15 цифр`):t.phone=`Введите телефон`,e.email?ve.test(e.email)||(t.email=`Введите корректный email`):t.email=`Введите email`,e.cardNumber?q(e.cardNumber).length!==16&&(t.cardNumber=`Номер карты должен содержать 16 цифр`):t.cardNumber=`Введите номер карты`,e.cardHolder?be.test(e.cardHolder)||(t.cardHolder=`Укажите имя владельца латиницей или кириллицей`):t.cardHolder=`Введите имя владельца карты`,e.expiry?Se(e.expiry)||(t.expiry=`Укажите корректный срок действия в формате MM/YY`):t.expiry=`Введите срок действия карты`,e.cvv?/^\d{3}$/.test(e.cvv)||(t.cvv=`CVV должен содержать 3 цифры`):t.cvv=`Введите CVV`,t},Q=(e,t)=>{[`city`,`address`,`phone`,`email`,`comment`,`cardNumber`,`cardHolder`,`expiry`,`cvv`].forEach(n=>{let r=e.querySelector(`[name="${n}"]`),i=e.querySelector(`[data-error-for="${n}"]`),a=t[n]||``;r&&(r.classList.toggle(`delivery-form__control--invalid`,!!a),r.setAttribute(`aria-invalid`,String(!!a))),i&&(i.textContent=a)})},Ce=()=>{let t=document.getElementById(`app`);if(!t)return;let n=t.querySelector(`.main`);if(n&&n.remove(),!m()){t.appendChild(e({tag:`main`,className:`main`,children:[e({tag:`div`,className:`cart-empty`,innerHTML:`
  ...
  `,t.appendChild(a);let o=document.getElementById(`delivery-form`),s=document.getElementById(`delivery-error`),c=o?.querySelector(`[name="cardNumber"]`)||null,l=o?.querySelector(`[name="expiry"]`)||null,u=o?.querySelector(`[name="cvv"]`)||null,d=()=>{if(!o)return{};let e=Z(X(o));return Q(o,e),e};c?.addEventListener(`input`,()=>{c.value=J(c.value),d()}),l?.addEventListener(`input`,()=>{l.value=Y(l.value),d()}),u?.addEventListener(`input`,()=>{u.value=q(u.value).slice(0,3),d()}),o?.querySelectorAll(`input, textarea`).forEach(e=>{e===c||e===l||e===u||e.addEventListener(`input`,()=>{d()})}),o?.addEventListener(`submit`,async e=>{e.preventDefault(),s&&(s.textContent=``);let n=X(o),i=Z(n);if(Q(o,i),Object.keys(i).length>0){s&&(s.textContent=`Проверьте корректность заполнения формы`),o.querySelector(`.delivery-form__control--invalid`)?.focus();return}let{city:a,address:c,phone:l,email:u,comment:d,cardNumber:f,cardHolder:p,expiry:m,cvv:g}=n;h({city:a,address:c,phone:l,comment:d});try{await fe({delivery:{city:a,address:c,phone:l,email:u,comment:d},payment:{cardNumber:f,cardHolder:p,expiry:m,cvv:g}}),localStorage.removeItem(`cart`);let e=t.querySelector(`.delivery-page`);e&&(e.innerHTML=`
        ...
        `,document.getElementById(`delivery-home-btn`)?.addEventListener(`click`,()=>{r(`/`)}))}catch(e){s&&(s.textContent=e instanceof Error?e.message:`Ошибка оформления`)}})},$=document.getElementById(`app`);if($){ee();let e=()=>{let e=$.querySelector(`.header`);e?e.replaceWith(C()):$.prepend(C())};e(),n(`/`,()=>{ce()}),n(`/product/:id`,e=>{e&&e.id&&R(e.id)}),n(`/cart`,()=>{_e()}),n(`/delivery`,()=>{Ce()}),n(`/login`,()=>{let e=$.querySelector(`.main`);e&&e.remove(),$.appendChild(ue())}),n(`/register`,()=>{let e=$.querySelector(`.main`);e&&e.remove(),$.appendChild(de())}),n(`/profile`,()=>{let e=$.querySelector(`.main`);e&&e.remove(),$.appendChild(he())}),window.addEventListener(`auth:changed`,()=>{e()}),window.addEventListener(`theme:changed`,()=>{e()}),o()}